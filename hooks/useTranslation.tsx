...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'fund.getTestTokens': 'Get Test Tokens',
    'fund.claiming': 'Claiming...',
    'fund.cooldown': 'Cooldown',
  ...
  pt: {
    ...
    'header.copyAddress': 'Copiar Endereço',
    'header.signOut': 'Sair',
    ...
    'bet.balance': 'Saldo',
    'fund.deposit': 'Depositar',
    'fund.getTestTokens': 'Tokens de Teste',
    'fund.claiming': 'Recebendo...',
    'fund.cooldown': 'Aguarde',
  ...
  es: {
    ...
    'header.copyAddress': 'Copiar Dirección',
    ...
    'bet.balance': 'Saldo',
    'fund.deposit': 'Depositar',
    'fund.getTestTokens': 'Tokens de Prueba',
    'fund.claiming': 'Recibiendo...',
    'fund.cooldown': 'Espere',
  ...
  fr: {
    ...
    'header.copyAddress': 'Copier l\'Adresse',
    ...
    'bet.available': 'Disponible',
    'bet.balance': 'Solde',
    'fund.deposit': 'Déposer',
    'fund.getTestTokens': 'Jetons de Test',
    'fund.claiming': 'Réception...',
    'fund.cooldown': 'Patientez',
  ...
  de: {
    ...
    'header.copyAddress': 'Adresse Kopieren',
    ...
    'fund.deposit': 'Einzahlen',
    'fund.getTestTokens': 'Test-Token',
    'fund.claiming': 'Empfange...',
    'fund.cooldown': 'Bitte warten',
